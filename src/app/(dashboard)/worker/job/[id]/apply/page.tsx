...
export default function ApplyPage() {
  ...
  return (
    <div className="mx-auto px-0 lg:px-6 py-4 lg:py-8">
      <div className="mb-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="md:col-span-2">
          <div className="mb-8 border border-nixerly-bussinessborder p-2 lg:p-5 rounded-2xl flex">
          ...
          <div className="sticky top-6 space-y-6">
            <Card>
              <CardContent className="space-y-4 px-0">
                <h2 className="text-base font-bold text-nixerly-blue px-4 lg:px-6">About this job</h2>
                <Separator />
                <div className="space-y-3 text-sm px-4 lg:px-6">
            ...
            <Card>
              <CardContent className="space-y-4 px-0 ">
                <h2 className="text-base font-bold px-4 lg:px-6 text-nixerly-blue">About the client</h2>
                <Separator />

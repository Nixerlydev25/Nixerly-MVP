...
export default function BlogPage() {
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3  ">
            {popularPosts.map((post) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className=" mb-3 line-clamp-2 text-[#141414] font-montserrat text-lg font-medium leading-7">{post.title}</h3>
  ...
  />
                    ...
                    <div className="text-sm text-gray-600">
                      <div className="  font-poppins text-sm font-medium">{post.author}</div>
                      <div>{post.date}</div>
                    </div>
                    <div className="ml-auto mb-5 text-gray-500 font-poppins text-sm font-normal">{post.views}</div>
                  </div>
                  <p className=" mb-4 line-clamp-3 text-[#787676] font-poppins text-sm font-normal">{post.excerpt}</p>
                ...
                <div className="flex flex-col md:flex-row ">
                  ...
                  <div className="flex-1 p-6">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className=" text-gray-900 mb-2 font-urbanist text-xl font-medium">{post.title}</h3>
                      <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1  whitespace-nowrap ml-4">
                        {post.category}
                      </span>
                    </div>
  ...
  />
                      ...
                      <div className="text-sm text-gray-600">
                        <span className="font-medium  font-poppins text-sm ">{post.author}</span>
                        <span className="mx-2">•</span>
                        <span>{post.date}</span>
                      </div>
                      <div className="ml-auto  text-gray-500 font-poppins text-sm font-normal">{post.views}</div>
                    </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              <span className="text-blue-600">Join Our</span> <span className="text-black">Newsletter</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-lg">
              ...
              />
              <Button className="bg-primary hover:bg-blue-700 text-white px-8 py-6 rounded-md font-medium">
                Subscribe
              </Button>
            </div>
          </div>

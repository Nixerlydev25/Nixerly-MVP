...
export default function ContactModal() {
  ...
  const contactData = activeModal === ModalType.CONTACT_MODAL ? (modalData as ContactModalData) : null;
        ...
        <div className="space-y-4 py-4">
          <div className="flex items-center gap-4">
            <Avatar className="h-16 w-16">
              <AvatarImage
                src={contactData?.applicant?.workerProfile?.profilePicture || ''}
                alt={
                  contactData?.applicant?.workerProfile?.user?.firstName +
                  ' ' +
              ...
              />
              <AvatarFallback>
                {contactData?.applicant?.workerProfile?.user?.firstName.charAt(0)}
              </AvatarFallback>
            </Avatar>
            <div>
